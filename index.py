...
def flipkart_scraper(search_query):
    ...
    if response.status_code == 200:
        ...
        for product in products:
            ...
            ratings_element = product.find("span", {"class": "_1lRcqv"})
            ...
            # Additional attributes can be extracted similarly
...
if __name__ == "__main__":
    search_query = "iPhone"
    data = flipkart_scraper(search_query)

    if data:
        save_to_csv(data)
        print("Data extraction successful. Check flipkart_mobiles.csv.")
    else:
